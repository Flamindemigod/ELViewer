...
use super::{abilities::{AbilityInfo, BeginCast, EffectChanged, EffectInfo, EndCast}, combat::{CombatEvent, HealthRegen, UnitAdded, UnitChanged, UnitRemoved}, player::PlayerInfo};
...
#[derive(Debug, Serialize, Deserialize, Type, Clone, Copy, Eq, PartialEq)]
pub enum TrialID {
    KynesAegis,
    SanitysEdge,
    LucentCitadel,
